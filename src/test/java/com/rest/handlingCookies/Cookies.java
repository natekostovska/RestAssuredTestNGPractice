package com.rest.handlingCookies;
...
public class Cookies {
    ...
    *
    * Designed to authenticate the user - logged in or not?. Maintain the user session/state
    ...
    * */
    ...
    public void form_authentication_using_csrf_token_cookie_example() {
        ...
        io.restassured.http.Cookies cookies=new io.restassured.http.Cookies(cookie,cookie1);
    ...
    public void fetch_multiple_cookies(){
        ...
        io.restassured.http.Cookies cookies1= response.getDetailedCookies();
